...
Item {
	...
	readonly property var socket: storage.assembled.socket
	...
	readonly property var activityLed: storage.assembled.activityLed
	...
	readonly property real calloutX: canvasX + callout.x * scaleFactor
	readonly property real calloutY: canvasY + callout.y * scaleFactor
	readonly property real calloutWidth: callout.width * scaleFactor
	readonly property real calloutHeight: callout.height * scaleFactor
	...
	Image {
		...
		source: root.asset(root.manifest.assets.socket)
		fillMode: Image.Stretch
		smooth: true
	...
	Image {
		...
		source: root.asset(root.manifest.assets.activityLed)
		fillMode: Image.Stretch
		smooth: true
	...
	Image {
		...
		source: root.asset(root.manifest.assets.ssd)
		fillMode: Image.Stretch
		smooth: true
